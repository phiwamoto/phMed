inherited PesqExameF: TPesqExameF
  Caption = 'PesqExameF'
  PixelsPerInch = 96
  TextHeight = 13
  inherited PnlFundo: TPanel
    inherited PnlCaption: TPanel
      inherited LblPesquisa: TLabel
        Width = 125
        Caption = 'Pesquisa de Exame'
        ExplicitWidth = 125
      end
    end
    inherited PnlFiltros: TPanel
      object LblExame: TLabel
        Left = 10
        Top = 5
        Width = 32
        Height = 13
      ...
      object EdtExame: TcxTextEdit
        Left = 10
        Top = 20
        Properties.OnChange = EdtExamePropertiesChange
        TabOrder = 0
        Width = 690
      end
    ...
    inherited GridPesquisa: TcxGrid
      inherited GridPesquisaDBTableView1: TcxGridDBTableView
        object GridPesquisaDBTableView1IDEXAME: TcxGridDBColumn
          DataBinding.FieldName = 'IDEXAME'
          Width = 80
        end
  ...
  inherited CdsPesquisa: TClientDataSet
    CommandText = 
      'SELECT EXA.*'#13#10'           ,SRE.DESCRICAO AS SITUACAOREGISTRO'#13#10'  F' +
      'ROM EXAME EXA'#13#10'            JOIN SITUACAOREGISTRO SRE ON (SRE.IDS' +
      'ITUACAOREGISTRO = EXA.IDSITUACAOREGISTRO)'#13#10'WHERE 1 = 1'
    object CdsPesquisaIDEXAME: TIntegerField
