inherited PesqCidadeF: TPesqCidadeF
  Caption = 'PesqCidadeF'
  PixelsPerInch = 96
  TextHeight = 13
  inherited PnlFundo: TPanel
    ...
    inherited GridPesquisa: TcxGrid
      inherited GridPesquisaDBTableView1: TcxGridDBTableView
        object GridPesquisaDBTableView1IDCIDADE: TcxGridDBColumn
        ...
        object GridPesquisaDBTableView1UF: TcxGridDBColumn
  ...
  inherited CdsPesquisa: TClientDataSet
    CommandText = 
      'SELECT cid.*'#13#10'            ,sre.descricao AS situacaoregistro'#13#10'  ' +
      'FROM cidade cid'#13#10'            JOIN situacaoregistro sre ON (sre.i' +
      'dsituacaoregistro = cid.idsituacaoregistro)'#13#10'WHERE 1 = 1'
