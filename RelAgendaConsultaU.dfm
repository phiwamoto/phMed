inherited RelAgendaConsultaF: TRelAgendaConsultaF
  Caption = 'Relat'#243'rio - Agenda de Consulta'
  OnClose = FormClose
  PixelsPerInch = 96
  TextHeight = 15
  inherited PnlGeral: TPanel
    ...
    object EdDataAgenda: TcxDateEdit
      Left = 15
      Top = 35
      TabOrder = 0
      Width = 100
